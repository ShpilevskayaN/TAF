...
public class CssSelectorTest {
    ...
    public void cssSelectorsTest() {
        driver.get("D:\\QA18\\TAF\\src\\test\\resources\\index.html");
        ...
        // Поиск всех элементов у которых присутствует аттрибут id со значением начинающимся на какое-то value или value/
